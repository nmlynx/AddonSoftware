...
WINDOW 1000 "Temporary Title" 10 40 0424 0249
BEGIN
    ...
    STATICTEXT 02011, "Next MTD Sales:", 234, 13, 93, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_sales"
    END
    INPUTN 03011, "", 330, 10, 64, 19
    BEGIN
        NAME "inn_nmtd_sales"
        CLIENTEDGE
        PASSENTER
    ...
    STATICTEXT 02012, "Next MTD Returns:", 217, 34, 110, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_returns"
    END
    INPUTN 03012, "", 330, 31, 64, 19
    BEGIN
    ...
    STATICTEXT 02013, "Next MTD Tax Amount:", 191, 55, 136, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_tax"
    END
    INPUTN 03013, "", 330, 52, 64, 19
    BEGIN
        NAME "inn_nmtd_tax"
        CLIENTEDGE
        PASSENTER
    ...
    STATICTEXT 02014, "Next MTD Freight:", 222, 76, 105, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nxt_mtd_frgt"
    END
    INPUTN 03014, "", 330, 73, 64, 19
    BEGIN
    ...
    STATICTEXT 02015, "Next MTD Cost:", 236, 97, 91, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nxt_mtd_cost"
    END
    INPUTN 03015, "", 330, 94, 64, 19
    BEGIN
    ...
    STATICTEXT 02016, "Next MTD Discount:", 211, 118, 116, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nxt_mtd_disc"
    END
    INPUTN 03016, "", 330, 115, 64, 19
    BEGIN
    ...
    STATICTEXT 02017, "Next MTD Cash Sales:", 201, 139, 126, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_cashsl"
    END
    INPUTN 03017, "", 330, 136, 64, 19
    BEGIN
    ...
    STATICTEXT 02018, "Next MTD Cash:", 234, 160, 93, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nxt_mtd_cash"
    END
    INPUTN 03018, "", 330, 157, 64, 19
    BEGIN
    ...
    STATICTEXT 02019, "Next MTD Cash Discount:", 178, 181, 149, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_cash_ds"
    END
    INPUTN 03019, "", 330, 178, 64, 19
    BEGIN
    ...
    STATICTEXT 02020, "Next MTD Cash to GL:", 200, 202, 127, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_cashgl"
    END
    INPUTN 03020, "", 330, 199, 64, 19
    BEGIN

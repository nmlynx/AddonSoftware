...
// BMM_BILLOPER - Operations Detail
...
BEGIN
    ...
    STATICTEXT 02003, "Internal Sequence Number:", 0, 55, 127, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_internal_seq_no"
    END
    
    INPUTE 03003, "", 130, 52, 156, 19
    BEGIN
        NAME "ine_internal_seq_no"
        CLIENTEDGE
        PASSENTER
        HIGHLIGHT
        PADCHARACTER 0
    ...
    STATICTEXT 02009, "Hours Per Piece:", 33, 181, 94, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02010, "Pieces Per Hour:", 33, 202, 94, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02012, "Move Time:", 61, 244, 66, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_move_time"

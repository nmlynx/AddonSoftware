...
WINDOW 1000 "Temporary Title" 10 40 0490 0459
BEGIN
    NAME "win_poe_recdet"
    MANAGESYSCOLOR
    KEYBOARDNAVIGATION
    ...
    STATICTEXT 02008, "Quantity Ordered:", 31, 160, 106, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02009, "Qty Previously Rec'd:", 14, 181, 123, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02010, "Quantity Received:", 29, 202, 108, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_qty_received"
    END
    INPUTN 03010, "", 140, 199, 64, 19
    BEGIN
    ...
    STATICTEXT 02011, "Unit Cost:", 79, 223, 58, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_unit_cost"
    END
    INPUTN 03011, "", 140, 220, 64, 19
    BEGIN
        NAME "inn_unit_cost"
        CLIENTEDGE
        PASSENTER
    ...
    STATICTEXT 02012, "Extended Cost:", 48, 244, 89, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_disp_ext_cost"
    END
    INPUTN 03012, "", 140, 241, 128, 19
    BEGIN
    ...
    STATICTEXT 02013, "Warehouse Location:", 15, 265, 122, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_location"
    ...
    STATICTEXT 02014, "Date Required:", 52, 286, 85, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_reqd_date"
    ...
    STATICTEXT 02015, "Sequence Ref Number:", 5, 307, 132, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    LISTBUTTON 03015, "", 140, 304, 119, 300
    BEGIN
    ...
    STATICTEXT 02016, "Delivery Promised By Date:", 0, 328, 137, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    BEGIN
        ...
        PLUSMINUS
    END
    TOOLBUTTON 21016, "", 225, 325, 20, 19
    BEGIN
        NAME "tbnc_promise_date"
    END
    
    STATICTEXT 02017, "Don't Deliver Before Date:", 0, 349, 137, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    BEGIN
        ...
        PLUSMINUS
    END
    TOOLBUTTON 21017, "", 225, 346, 20, 19
    BEGIN
        NAME "tbnc_not_b4_date"
    END
    
    STATICTEXT 02018, "PO Standard Message Code:", 0, 370, 137, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 04018, "", 205, 371, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        ...
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20018, "", 179, 367, 20, 19
    BEGIN
        NAME "tbnf_po_msg_code"
    END
    
    STATICTEXT 02019, "Work Order Number:", 15, 391, 122, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_wo_no"
    ...
    STATICTEXT 02020, "Sequence number reference:", 0, 412, 137, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_wo_seq_ref"

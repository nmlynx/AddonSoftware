...
// SFE_WOSUBADJ - WO Subcontract Cost Adjustment
...
BEGIN
    ...
    STATICTEXT 02008, "Unit Cost After Adjustment:", 0, 160, 127, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_new_unit_cst"
    END
    INPUTN 03008, "", 130, 157, 64, 19
    BEGIN
        NAME "inn_new_unit_cst"
        CLIENTEDGE
        PASSENTER
        HIGHLIGHT
        MASK "######0-"

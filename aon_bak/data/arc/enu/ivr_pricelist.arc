...
BEGIN
    ...
    CHECKBOX 03001, "Include Unit Cost and Margin?", 128, 10, 206, 19
    BEGIN
        NAME "cbx_unit_cost_marg"
        NOT OPAQUE
    END
    
    STATICTEXT 02002, "Beginning Warehouse ID:", 0, 34, 127, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02003, "Ending Warehouse ID:", 0, 55, 127, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_warehouse_id"

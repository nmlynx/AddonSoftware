...
BEGIN
    ...
    STATICTEXT 02010, "Open/Closed/Both:", 12, 202, 115, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_op_cl_both"
    ...
    LISTBUTTON 03010, "", 130, 199, 69, 300
    BEGIN
        NAME "lbx_op_cl_both"
        SELECTIONHEIGHT 19
        CLIENTEDGE
    ...
    CHECKBOX 03011, "Total By Item?", 128, 220, 110, 19
    BEGIN
        NAME "cbx_pick_check"
        NOT OPAQUE
    END
    ...
    CHECKBOX 03012, "ALL transactions", 28, 262, 129, 19
    BEGIN
        NAME "cbx_tran_hst_all"
        NOT OPAQUE
    END
    
    CHECKBOX 03013, "Purchase Orders", 28, 304, 129, 19
    BEGIN
        NAME "cbx_tran_hst_po"
        NOT OPAQUE
    END
    
    CHECKBOX 03014, "Sales", 28, 325, 59, 19
    BEGIN
        NAME "cbx_tran_hst_op"
        NOT OPAQUE
    END
    
    CHECKBOX 03015, "Inventory Trans", 28, 346, 123, 19
    BEGIN
        NAME "cbx_tran_hst_it"
        NOT OPAQUE
    END
    
    CHECKBOX 03016, "Physical Inventory", 188, 304, 136, 19
    BEGIN
        NAME "cbx_tran_hst_ph"
        NOT OPAQUE
    END
    
    CHECKBOX 03017, "Transfers In", 188, 325, 101, 19
    BEGIN
        NAME "cbx_tran_hst_ti"
        NOT OPAQUE
    END
    
    CHECKBOX 03018, "Transfers Out", 188, 346, 112, 19
    BEGIN
        NAME "cbx_tran_hst_to"
        NOT OPAQUE
    END
    
    CHECKBOX 03019, "Work Orders Issued", 348, 304, 146, 19
    BEGIN
        NAME "cbx_tran_hst_wi"
        NOT OPAQUE
    END
    
    CHECKBOX 03020, "Work Orders Received", 348, 325, 159, 19
    BEGIN
        NAME "cbx_tran_hst_wo"
        NOT OPAQUE
    END
    
    CHECKBOX 03021, "Bill of Materials Prod", 348, 346, 148, 19
    BEGIN

...
BEGIN
    ...
    TABCONTROL 1050, "tab_ope_ordhdr", 4, 0055, 0993, 0237
    BEGIN
        NAME "tab_ope_ordhdr"
        FIXEDWIDTH
        NOT RIGHTJUSTIFY
    ...
    STATICTEXT 02003, "Order Total:", 396, 13, 71, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_order_tot"
    END
    INPUTN 03003, "", 470, 10, 80, 19
    BEGIN
        NAME "inn_order_tot"
        CLIENTEDGE
        PASSENTER
    ...
    STATICTEXT 02004, "Taken By:", 412, 34, 55, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
...
BEGIN
    ...
    STATICTEXT 02205, "PO Number:", 37, 118, 70, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02206, "PO Release No:", 271, 13, 86, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02207, "Misc Number:", 277, 34, 80, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_misc_no"
    ...
    STATICTEXT 02208, "Customer Ship Via:", 246, 55, 111, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02209, "Sales Disc Code:", 262, 76, 95, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_disc_code"
    ...
    STATICTEXT 04209, "", 421, 77, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_disc_code"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20209, "", 395, 73, 20, 19
    BEGIN
        NAME "tbnf_disc_code"
    END
    
    STATICTEXT 02210, "Terms Code:", 283, 97, 74, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_terms_code"
    ...
    STATICTEXT 04210, "", 421, 98, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_terms_code"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20210, "", 395, 94, 20, 19
    BEGIN
        NAME "tbnf_terms_code"
    END
    
    STATICTEXT 02211, "Distribution Code:", 250, 118, 107, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 04211, "", 421, 119, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        ...
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20211, "", 395, 115, 20, 19
    BEGIN
        NAME "tbnf_ar_dist_code"
    END
    
    STATICTEXT 02212, "Salesperson Code:", 569, 13, 108, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 04212, "", 741, 14, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        ...
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20212, "", 715, 10, 20, 19
    BEGIN
        NAME "tbnf_slspsn_code"
    END
    
    STATICTEXT 02213, "Standard Message Code:", 533, 34, 144, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 04213, "", 741, 35, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        ...
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20213, "", 715, 31, 20, 19
    BEGIN
        NAME "tbnf_message_code"
    END
    
    STATICTEXT 02214, "Territory Code:", 587, 55, 90, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_territory"
    ...
    STATICTEXT 04214, "", 741, 56, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_territory"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20214, "", 715, 52, 20, 19
    BEGIN
        NAME "tbnf_territory"
    END
    
    STATICTEXT 02215, "Tax Code:", 618, 76, 59, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_tax_code"
    ...
    STATICTEXT 04215, "", 741, 77, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_tax_code"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20215, "", 715, 73, 20, 19
    BEGIN
        NAME "tbnf_tax_code"
    END
    
    STATICTEXT 02216, "List Price Code:", 587, 97, 90, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_price_code"
    ...
    STATICTEXT 02217, "Job Number:", 605, 118, 72, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_job_no"
    ...
    STATICTEXT 04217, "", 786, 119, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_job_no"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20217, "", 760, 115, 20, 19
    BEGIN
        NAME "tbnf_job_no"
    END

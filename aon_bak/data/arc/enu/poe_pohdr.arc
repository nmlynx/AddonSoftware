...
// POE_POHDR - Purchase Order Header
// Proprietary Information. BASIS International Ltd. All rights reserved.

VERSION "4.0"

WINDOW 1000 "Temporary Title" 10 40 1026 0613
BEGIN
    NAME "win_poe_pohdr"
    MANAGESYSCOLOR
    KEYBOARDNAVIGATION
    ...
    TABCONTROL 1050, "tab_poe_pohdr", 4, 0139, 1019, 0279
    BEGIN
        NAME "tab_poe_pohdr"
        FIXEDWIDTH
        NOT RIGHTJUSTIFY
    ...
    BEGIN
        NAME "chp_poe_pohdr_1100"
    END
    
    CHILD-WINDOW 1101, 1101, 10, 88
    BEGIN
        NAME "chp_poe_pohdr_1101"
    END
    ...
    STATICTEXT 02011, "Total Amount:", 644, 118, 83, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    BEGIN
        ...
        MASK "######0-"
    END
    CHILD-WINDOW 1109 1109 5 0421
END
CHILD-WINDOW 1100 0 0 1016 0257
BEGIN
    NAME "chw_poe_pohdr_1100"
    BORDERLESS
...
END
CHILD-WINDOW 1101 0 0 1016 0257
BEGIN
    NAME "chw_poe_pohdr_1101"
    BORDERLESS
    BACKGROUNDCOLOR RGB(248,248,248)
    KEYBOARDNAVIGATION
    EVENTMASK 62915588
...
BEGIN
    ...
    BEGIN
        ...
        GRIDCOLWIDTH 9, 56
        GRIDCOLTITLE 9, "Qty Ord"
        GRIDCOLWIDTH 10, 56
        GRIDCOLTITLE 10, "Qty Received"
        GRIDCOLWIDTH 11, 56
        GRIDCOLTITLE 11, "Unit Cost"
        GRIDCOLWIDTH 12, 120
        GRIDCOLTITLE 12, "Ext Cost"
        GRIDCOLWIDTH 13, 80
        GRIDCOLTITLE 13, "Whse Loc"
        GRIDCOLWIDTH 14, 64
        GRIDCOLTITLE 14, "Date Req"
        GRIDCOLWIDTH 15, 96
        GRIDCOLTITLE 15, "SO Seq No"
        GRIDCOLWIDTH 16, 64
        GRIDCOLTITLE 16, "Del Prom By"
        GRIDCOLWIDTH 17, 64
        GRIDCOLTITLE 17, "Don't Del Bef"
        GRIDCOLWIDTH 18, 35
        GRIDCOLTITLE 18, "Std Msg Cd"
        GRIDCOLWIDTH 19, 56
        GRIDCOLTITLE 19, "WO No"
        GRIDCOLWIDTH 20, 35
        GRIDCOLTITLE 20, "WO Seq No"
    END

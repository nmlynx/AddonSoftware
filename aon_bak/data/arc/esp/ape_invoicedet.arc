...
BEGIN
    ...
    STATICTEXT 04005, "", 262, 98, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_gl_account"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20005, "", 236, 94, 20, 19
    BEGIN
        NAME "tbnf_gl_account"
    END
    
    STATICTEXT 02006, "Varios:", 113, 118, 40, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02009, "Número de control de entrada de lote:", 0, 181, 153, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_batch_no"

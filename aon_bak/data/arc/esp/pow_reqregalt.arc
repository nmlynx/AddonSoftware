...
// POW_REQREGALT - Alternate Seq/Vendor/Req No
...
BEGIN
    ...
    STATICTEXT 02001, "Secuencia alternativa:", 27, 13, 126, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02003, "Requisition Number:", 34, 55, 119, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_req_no"

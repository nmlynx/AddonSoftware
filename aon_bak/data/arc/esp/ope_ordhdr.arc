...
BEGIN
    ...
    TABCONTROL 1050, "tab_ope_ordhdr", 4, 0055, 1127, 0237
    BEGIN
        NAME "tab_ope_ordhdr"
        FIXEDWIDTH
        NOT RIGHTJUSTIFY
    ...
    BEGIN
        NAME "chp_ope_ordhdr_1100"
    END
    
    CHILD-WINDOW 1101, 1101, 10, 88
    BEGIN
        NAME "chp_ope_ordhdr_1101"
    END
    
    CHILD-WINDOW 1102, 1102, 10, 88
    BEGIN
        NAME "chp_ope_ordhdr_1102"
    END
    ...
    STATICTEXT 02003, "Order Total:", 490, 13, 71, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_order_tot"
    END
    INPUTN 03003, "", 564, 10, 80, 19
    BEGIN
        NAME "inn_order_tot"
        CLIENTEDGE
        PASSENTER
    ...
    STATICTEXT 02004, "Taken By:", 506, 34, 55, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
...
BEGIN
    ...
    STATICTEXT 02205, "PO Number:", 59, 118, 70, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02206, "PO Release No:", 343, 13, 86, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02207, "Misc Number:", 349, 34, 80, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_misc_no"
    ...
    STATICTEXT 02208, "Medio de envío al cliente:", 283, 55, 146, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02209, "Sales Disc Code:", 334, 76, 95, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_disc_code"
    ...
    STATICTEXT 04209, "", 493, 77, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_disc_code"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20209, "", 467, 73, 20, 19
    BEGIN
        NAME "tbnf_disc_code"
    END
    
    STATICTEXT 02210, "Terms Code:", 355, 97, 74, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_terms_code"
    ...
    STATICTEXT 04210, "", 493, 98, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_terms_code"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20210, "", 467, 94, 20, 19
    BEGIN
        NAME "tbnf_terms_code"
    END
    
    STATICTEXT 02211, "Código de distribución:", 291, 118, 138, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 04211, "", 493, 119, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        ...
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20211, "", 467, 115, 20, 19
    BEGIN
        NAME "tbnf_ar_dist_code"
    END
    
    STATICTEXT 02212, "Código de vendedor:", 690, 13, 123, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 04212, "", 877, 14, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        ...
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20212, "", 851, 10, 20, 19
    BEGIN
        NAME "tbnf_slspsn_code"
    END
    
    STATICTEXT 02213, "Standard Message Code:", 669, 34, 144, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 04213, "", 877, 35, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        ...
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20213, "", 851, 31, 20, 19
    BEGIN
        NAME "tbnf_message_code"
    END
    
    STATICTEXT 02214, "Código de territorio:", 692, 55, 121, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_territory"
    ...
    STATICTEXT 04214, "", 877, 56, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_territory"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20214, "", 851, 52, 20, 19
    BEGIN
        NAME "tbnf_territory"
    END
    
    STATICTEXT 02215, "Código impositivo:", 702, 76, 111, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_tax_code"
    ...
    STATICTEXT 04215, "", 877, 77, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_tax_code"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20215, "", 851, 73, 20, 19
    BEGIN
        NAME "tbnf_tax_code"
    END
    
    STATICTEXT 02216, "List Price Code:", 723, 97, 90, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_price_code"
    ...
    STATICTEXT 02217, "Número de trabajo:", 700, 118, 113, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_job_no"
    ...
    STATICTEXT 04217, "", 922, 119, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_job_no"
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20217, "", 896, 115, 20, 19
    BEGIN
        NAME "tbnf_job_no"
    END

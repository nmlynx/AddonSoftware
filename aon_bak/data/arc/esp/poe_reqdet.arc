...
WINDOW 1000 "Temporary Title" 10 40 0518 0417
BEGIN
    NAME "win_poe_reqdet"
    MANAGESYSCOLOR
    KEYBOARDNAVIGATION
    ...
    STATICTEXT 02008, "Requisition Quantity:", 42, 160, 123, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_req_qty"
    ...
    STATICTEXT 02009, "Unit Cost:", 107, 181, 58, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_unit_cost"
    ...
    STATICTEXT 02010, "Extended cost:", 79, 202, 86, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_disp_ext_cost"
    END
    INPUTN 03010, "", 168, 199, 128, 19
    BEGIN
    ...
    STATICTEXT 02011, "Warehouse Location:", 43, 223, 122, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_location"
    ...
    STATICTEXT 02012, "Date Required:", 80, 244, 85, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_reqd_date"
    ...
    BEGIN
        ...
        PLUSMINUS
    END
    TOOLBUTTON 21012, "", 253, 241, 20, 19
    BEGIN
        NAME "tbnc_reqd_date"
    END
    
    STATICTEXT 02013, "Sequence Ref Number:", 33, 265, 132, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    LISTBUTTON 03013, "", 168, 262, 119, 300
    BEGIN
    ...
    STATICTEXT 02014, "Delivery Promised By Date:", 10, 286, 155, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02015, "Don't Deliver Before Date:", 16, 307, 149, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    BEGIN
        ...
        PLUSMINUS
    END
    TOOLBUTTON 21015, "", 253, 304, 20, 19
    BEGIN
        NAME "tbnc_not_b4_date"
    END
    
    STATICTEXT 02016, "PO Standard Message Code:", 2, 328, 163, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 04016, "", 233, 329, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        ...
        FOREGROUNDCOLOR RGB(0,0,96)
    END
    TOOLBUTTON 20016, "", 207, 325, 20, 19
    BEGIN
        NAME "tbnf_po_msg_code"
    END
    
    STATICTEXT 02017, "Work Order Number:", 43, 349, 122, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_wo_no"
    ...
    STATICTEXT 02018, "Sequence number reference:", 0, 370, 165, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_wo_seq_ref"

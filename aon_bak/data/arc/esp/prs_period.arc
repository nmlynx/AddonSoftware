...
BEGIN
    ...
    STATICTEXT 02001, "Deduction Period:", 49, 13, 104, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_deduct_per"
    ...
    CHECKBOX 03002, "Automatic Update?", 154, 31, 141, 19
    BEGIN
        NAME "cbx_auto_update"
        NOT OPAQUE
    END
    
    STATICTEXT 02003, "Pay Periods:", 83, 55, 70, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02004, "Accrual Days:", 73, 76, 80, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    CHECKBOX 03005, "Negative Checks?", 154, 94, 132, 19
    BEGIN
        NAME "cbx_negative_chk"
        NOT OPAQUE
    END
    
    STATICTEXT 02006, "Payroll Period End Date:", 15, 118, 138, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768

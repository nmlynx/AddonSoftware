...
BEGIN
    ...
    STATICTEXT 02001, "Número de transacción:", 13, 13, 140, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_trans_no"
    ...
    STATICTEXT 02002, "Tipo de transacción:", 34, 34, 119, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_trans_type"
    ...
    LISTBUTTON 03002, "", 156, 31, 108, 300
    BEGIN
        NAME "lbx_trans_type"
        SELECTIONHEIGHT 19
        CLIENTEDGE
    ...
    STATICTEXT 02005, "Monto de la transacción:", 9, 97, 144, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_trans_amt"
    END
    INPUTN 03005, "", 156, 94, 77, 19
    BEGIN
        NAME "inn_trans_amt"
        CLIENTEDGE
        PASSENTER
    ...
    STATICTEXT 02006, "Código registrado:", 42, 118, 111, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768

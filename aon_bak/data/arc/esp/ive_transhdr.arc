...
WINDOW 1000 "Temporary Title" 10 40 0718 0365
BEGIN
    ...
    STATICTEXT 02002, "Reference Number:", 41, 34, 112, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02004, "Transaction Code:", 286, 34, 107, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_trans_code"
    ...
    STATICTEXT 04004, "", 457, 35, 200, 15
    BEGIN
        NOT OPAQUE
        NOT WORDWRAP
        NAME "dis_trans_code"
    ...
    END
    TOOLBUTTON 20004, "", 431, 31, 20, 19
    BEGIN
        NAME "tbnf_trans_code"
    END
    
    STATICTEXT 02005, "Comment:", 333, 55, 60, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_trans_cmt"
    ...
    STATICTEXT 02006, "Location:", 16, 118, 53, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_location"
    ...
    STATICTEXT 02007, "On Hand:", 230, 118, 55, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_qty_on_hand"
    END
    INPUTN 03007, "", 288, 115, 64, 19
    BEGIN
    ...
    STATICTEXT 02008, "Committed:", 385, 118, 68, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_qty_commit"
    END
    INPUTN 03008, "", 456, 115, 64, 19
    BEGIN
        NAME "inn_qty_commit"
        CLIENTEDGE
        PASSENTER
    ...
    STATICTEXT 02009, "Available:", 565, 118, 56, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_qty_avail"
    END
    INPUTN 03009, "", 624, 115, 64, 19
    BEGIN
        NAME "inn_qty_avail"
        CLIENTEDGE
        PASSENTER

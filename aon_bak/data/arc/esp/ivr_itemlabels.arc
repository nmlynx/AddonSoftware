...
// IVR_ITEMLABELS - Inventory Item Labels
...
BEGIN
    ...
    STATICTEXT 02001, "Beginning Warehouse ID:", 8, 13, 145, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02002, "Ending Warehouse ID:", 26, 34, 127, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_warehouse_id"
    ...
    STATICTEXT 02008, "Number of Labels:", 47, 160, 106, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_pick_count"
    END
    INPUTN 03008, "", 156, 157, 40, 19
    BEGIN
        NAME "inn_pick_count"
        CLIENTEDGE
        PASSENTER

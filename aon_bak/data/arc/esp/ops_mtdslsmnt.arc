...
// OPS_MTDSLSMNT - Month to Date Sales Totals
// Proprietary Information. BASIS International Ltd. All rights reserved.

VERSION "4.0"

WINDOW 1000 "Temporary Title" 10 40 0490 0249
BEGIN
    NAME "win_ops_mtdslsmnt"
    MANAGESYSCOLOR
    KEYBOARDNAVIGATION
    DIALOGBEHAVIOR
    ...
    STATICTEXT 02011, "Ventas de próximo MTD:", 249, 13, 144, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_sales"
    END
    INPUTN 03011, "", 396, 10, 64, 19
    BEGIN
        NAME "inn_nmtd_sales"
        CLIENTEDGE
        PASSENTER
    ...
    STATICTEXT 02012, "Next MTD Returns:", 283, 34, 110, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_returns"
    END
    INPUTN 03012, "", 396, 31, 64, 19
    BEGIN
    ...
    STATICTEXT 02013, "Next MTD Tax Amount:", 257, 55, 136, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_tax"
    END
    INPUTN 03013, "", 396, 52, 64, 19
    BEGIN
        NAME "inn_nmtd_tax"
        CLIENTEDGE
        PASSENTER
    ...
    STATICTEXT 02014, "Next MTD Freight:", 288, 76, 105, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nxt_mtd_frgt"
    END
    INPUTN 03014, "", 396, 73, 64, 19
    BEGIN
    ...
    STATICTEXT 02015, "Costo de próximo MTD:", 254, 97, 139, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nxt_mtd_cost"
    END
    INPUTN 03015, "", 396, 94, 64, 19
    BEGIN
    ...
    STATICTEXT 02016, "Next MTD Discount:", 277, 118, 116, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nxt_mtd_disc"
    END
    INPUTN 03016, "", 396, 115, 64, 19
    BEGIN
    ...
    STATICTEXT 02017, "Next MTD Cash Sales:", 267, 139, 126, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_cashsl"
    END
    INPUTN 03017, "", 396, 136, 64, 19
    BEGIN
    ...
    STATICTEXT 02018, "Efectivo de próximo MTD:", 243, 160, 150, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nxt_mtd_cash"
    END
    INPUTN 03018, "", 396, 157, 64, 19
    BEGIN
    ...
    STATICTEXT 02019, "Descuento de efectivo de próximo MTD:", 159, 181, 234, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_cash_ds"
    END
    INPUTN 03019, "", 396, 178, 64, 19
    BEGIN
    ...
    STATICTEXT 02020, "Efectivo de próximo MTD para el GL:", 181, 202, 212, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_nmtd_cashgl"
    END
    INPUTN 03020, "", 396, 199, 64, 19
    BEGIN

...
WINDOW 1000 "Temporary Title" 10 40 0386 0123
BEGIN
    ...
    STATICTEXT 02001, "Lot/Serial Number:", 42, 13, 111, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
        NAME "txt_lotser_no"
    ...
    STATICTEXT 02002, "Quantity Ordered:", 47, 34, 106, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768
    ...
    STATICTEXT 02003, "Quantity Shipped:", 49, 55, 104, 16
    BEGIN
        NOT OPAQUE
        JUSTIFICATION 32768

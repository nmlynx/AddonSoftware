...
call syspgmdir$+"bac_key_template.bbj","SAM_PRODITMCST","ALT_KEY_01",key_temp$,table_chans$[all],rd_stat$
dim rd_key$:key_temp$
...
sam_tpl$=fnget_tpl$("SAM_PRODITMCST")
dim sam_tpl$:sam_tpl$
while 1
	readrecord(fnget_dev("SAM_PRODITMCST"),key=rd_key$,knum=1,dom=*break)sam_tpl$

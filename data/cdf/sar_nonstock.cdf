[[SAR_NONSTOCK.PRIOR.AVAL]]
if callpoint!.getColumnData("SAR_NONSTOCK.PRIOR") = "Y" 
	if callpoint!.getColumnData("SAR_NONSTOCK.MTD") <> "Y" and
:	   callpoint!.getColumnData("SAR_NONSTOCK.YTD") <> "Y"

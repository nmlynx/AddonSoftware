[[SAR_SALESPSN.PRIOR.AVAL]]
if callpoint!.getColumnData("SAR_SALESPSN.PRIOR") = "Y" 
	if callpoint!.getColumnData("SAR_SALESPSN.MTD") <> "Y" and
:	   callpoint!.getColumnData("SAR_SALESPSN.YTD") <> "Y"

...
rem --- Verify WO Order is Open or Planned
	...
	if cvs(wo_no$,3)<>""
		...
		wo_loc$=sfe_womast.wo_location$
		read record(sfe_womast,key=firm_id$+wo_loc$+wo_no$) sfe_womast$
		if pos(sfe_womast.wo_status$="QC")>0
			msg_id$="SF_QUOTE_CLOSED"
			gosub disp_message

...
callpoint!.setColumnData("WAREHOUSE_ID_1","01")
callpoint!.setColumnData("WAREHOUSE_ID_2","01")

callpoint!.setColumnData("PRODUCT_TYPE_01","A")
callpoint!.setColumnData("PRODUCT_TYPE_02","A")

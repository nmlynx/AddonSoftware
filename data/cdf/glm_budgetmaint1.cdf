[[GLM_BUDGETMAINT1.GL_ACCOUNT.AVAL]]
...
if cvs(glm01a.gl_account$,3)<>""
	callpoint!.setColumnData("GLM_BUDGETMAINT1.GL_ACCT_TYPE",glm01a.gl_acct_type$)
	callpoint!.setColumnData("GLM_BUDGETMAINT1.DETAIL_FLAG",glm01a.detail_flag$)
	gosub fill_gridBudgets
	callpoint!.setStatus("REFRESH")
else
	callpoint!.setStatus("ABORT")
endif
[[GLM_BUDGETMAINT1.AREC]]
...
switch notice.code
	...
	case 7;rem edit stop
		...
		if curr_col=0
			...
			glm02_key$=firm_id$+callpoint!.getColumnData("GLM_BUDGETMAINT1.GL_ACCOUNT")+budget_type$(1,1)
...
format_gridBudgets:
	...
	for curr_attr=1 to def_grid_cols
		...
		attr_grid_col$[0,1]=attr_grid_col$[0,1]+pad("GLM_BUDGETMAINT1."+attr_grid_col$[curr_attr,
...
fill_gridBudgets:
	...
	tps!=UserObj!.getItem(num(user_tpl.tps_ofst$))
	num_cols=cols!.size()	
	gl_account$=callpoint!.getColumnData("GLM_BUDGETMAINT1.GL_ACCOUNT")
...
gridBudgets!.setCallback(gridBudgets!.ON_GRID_CELL_MODIFY,"custom_event")
...
gridBudgets!.setCallback(gridBudgets!.ON_GRID_SELECT_ROW,"custom_event")
gridBudgets!.setCallback(gridBudgets!.ON_GRID_SELECT_COLUMN,"custom_event")

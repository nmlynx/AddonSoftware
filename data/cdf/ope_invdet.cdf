...
rem --- Check item/warehouse combination and setup values
	...
	wh$         = callpoint!.getColumnData("OPE_INVDET.WAREHOUSE_ID")
	prev_item$  = callpoint!.getColumnUndoData("OPE_INVDET.ITEM_ID")
...
rem --- Set shipped and back ordered
	...
	prev_qty_ord = num(callpoint!.getColumnUndoData("OPE_INVDET.QTY_ORDERED"))
	qty_ord      = num(callpoint!.getColumnData("OPE_INVDET.QTY_ORDERED"))
	unit_price   = num(callpoint!.getColumnData("OPE_INVDET.UNIT_PRICE"))
...
rem --- recalc quantities and extended price
	...
	prev_shipqty = num(callpoint!.getColumnUndoData("OPE_INVDET.QTY_SHIPPED"))
...
rem --- Recalc quantities and extended price
   ...
   prev_boqty = num(callpoint!.getColumnUndoData("OPE_INVDET.QTY_BACKORD"))
	ordqty     = num(callpoint!.getColumnData("OPE_INVDET.QTY_ORDERED"))
...
rem --- Has line code changed?
	...
	prev_line_code$ = callpoint!.getColumnUndoData("OPE_INVDET.LINE_CODE")
	...
	if line_code$ <> prev_line_code$ then
		...
		rem needed? callpoint!.setColumnEnabled("OPE_INVDET.QTY_BACKORD", 1)
	endif
